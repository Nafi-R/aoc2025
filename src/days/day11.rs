...
mod test {
    ...
    static DAY_STR: &str = "day11";

    #[ignore]
    #[test]
    fn test_day11_part1_example_input() {
    ...
    #[ignore]
    #[test]
    fn test_day11_part1_full_input() {
    ...
    #[ignore]
    #[test]
    fn test_day11_part2_example_input() {
        let file_path = format!("{}{}", DAY_STR, "_test");
        let file_lines = get_day_lines(&file_path).unwrap();
    ...
    #[ignore]
    #[test]
    fn test_day11_part2_full_input() {
        let file_path = format!("{}", DAY_STR);
        let file_lines = get_day_lines(&file_path).unwrap();
        let actual = part2(file_lines).unwrap();
